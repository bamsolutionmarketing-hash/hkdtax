...
export default function App() {
    ...
    const refreshTransactions = useCallback(async () => {
        const { loadTransactions } = await import('./lib/db');
    ...
    return (<><style>{STYLES}</style><div className="app-shell">
        ...
        <main className="main-content">
            ...
            {page === "invoice" && <InvoicePage business={business} setBusiness={saveBiz} addToast={addToast} onInvoiceCreated={refreshTransactions} />}
